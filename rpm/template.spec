...
%description
rqt_action provides a feature to introspect all available ROS action types. By
utilizing rqt_msg, the output format is unified with it and rqt_srv. Note that
the actions shown on this plugin is the ones that are stored on your machine,
...
%changelog
* Fri Jan 14 2022 Audrow Nash <audrow@openrobotics.org> - 2.0.1-1
- Autogenerated by Bloom

* Tue Apr 20 2021 Mikael Arguedas <mikael@osrfoundation.org> - 2.0.0-2
- Autogenerated by Bloom

* Thu Mar 18 2021 Mikael Arguedas <mikael@osrfoundation.org> - 2.0.0-1
- Autogenerated by Bloom

* Mon Mar 08 2021 Mikael Arguedas <mikael@osrfoundation.org> - 1.0.1-2
- Autogenerated by Bloom
